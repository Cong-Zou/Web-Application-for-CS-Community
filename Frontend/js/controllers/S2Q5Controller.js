...
angular.module("sose-research-community")
    .controller("S2Q5Controller", function ($scope, $http, $timeout) {
        $scope.changePCView = "";
        ...
        $scope.getResult = function () {
            ...
            $http.get(`/api/paper/categorize?startYear=${startYear}&endYear=${endYear}&keywords=${keywords}&channelName=${encodeURIComponent(channelName)}`).then(function (response) {
